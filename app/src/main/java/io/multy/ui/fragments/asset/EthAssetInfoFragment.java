...
/**
 * Created by anschutz1927@gmail.com on 20.03.18.
 */

public class EthAssetInfoFragment extends BaseFragment implements AppBarLayout.OnOffsetChangedListener {

    public static final String TAG = EthTransactionFeeFragment.class.getSimpleName();
    ...
    @BindView(R.id.text_token_value)
    TextView textTokenBalanceOriginal;
